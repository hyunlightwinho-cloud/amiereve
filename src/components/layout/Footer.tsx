  ...
  return (
    <footer className="bg-brand-dark text-white" style={{ borderTop: '4px solid #FEE500' }}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 mb-12">
          {/* Logo & Tagline */}
          <div>
            <div className="mb-3">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center hover:bg-brand-yellow hover:text-brand-dark transition-all duration-200 hover:scale-105"
              >
